...
```bash
# Test tools endpoint
curl -H "x-api-key: your-api-key" http://localhost:3000/myagent/tools
...
curl -X POST \
  ...
  -d '{"param1": "value1"}' \
  http://localhost:3000/myagent/tools/toolName

# Test resource endpoint (optional)
curl -X POST \
  -H "x-api-key: your-api-key" \
  -H "Content-Type: application/json" \
  -d '{}' \
  http://localhost:3000/myagent/resource
```
...
curl -X POST \
 -H "x-api-key: your-api-key" \
 -H "x-variable-name-1: your-variable-value" \
 -H "x-variable-name-2: your-variable-value" \
 -H "Content-Type: application/json" \
 -d '{"param1": "value1"}' \
 http://localhost:3000/myagent/tools/toolName
